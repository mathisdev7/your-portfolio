...
import porfolio from 'portfolio.config';
...
const ACTIONS: Array<NavigationItem> = [
	...
	},
	{
		type: NavigationItemType.LINK,
		external: true,
		href: `https://github.com/${porfolio.github.username}`,
...
export default function HomePage(): JSX.Element {
	...
	const birthday = new Date(portfolio.birthday);
	const isBirthday =
			...
			<div className="min-h-screen flex items-center justify-center py-12">
				<div className="max-w-sm sm:max-w-lg md:sm:max-w-2xl lg:sm:max-w-3xl w-full space-y-8 text-center">
					<Animate
						...
						I&apos;m {portfolio.name}, <br className="hidden sm:block" />a{' '}
